...
function MarkerClusterer(map, opt_markers, opt_options) {
	this.extend(MarkerClusterer, google.maps.OverlayView),
		...
		(this.zoomOnClick_ = !0),
		void 0 !== opt_options.zoomOnClick && (this.zoomOnClick_ = opt_options.zoomOnClick),
		(this.averageCenter_ = !1),
		void 0 !== opt_options.averageCenter && (this.averageCenter_ = opt_options.averageCenter),
		(this.ignoreHidden_ = !1),
		void 0 !== opt_options.ignoreHidden && (this.ignoreHidden_ = opt_options.ignoreHidden),
		(this.enableRetinaIcons_ = !1),
		void 0 !== opt_options.enableRetinaIcons && (this.enableRetinaIcons_ = opt_options.enableRetinaIcons),
		(this.hideLabel_ = !1),
		void 0 !== opt_options.hideLabel && (this.hideLabel_ = opt_options.hideLabel),
...
(ClusterIcon.prototype.onAdd = function() {
	...
	(Cluster.prototype.addMarker = function(marker) {
		...
		else if (mCount === this.minClusterSize_) for (i = 0; mCount > i; i++) this.markers_[i].setMap(null);
			...
			(this.listeners_ = [
				google.maps.event.addListener(this.getMap(), 'zoom_changed', function() {
					cMarkerClusterer.resetViewport_(!1),
						(this.getZoom() === (this.get('minZoom') || 0) || this.getZoom() === this.get('maxZoom')) &&
	...
	(MarkerClusterer.prototype.addToClosestCluster_ = function(marker) {
		...
		clusterToAddTo && clusterToAddTo.isMarkerInClusterBounds(marker)
			...
			: ((cluster = new Cluster(this)), cluster.addMarker(marker), this.clusters_.push(cluster));
	}),
	(MarkerClusterer.prototype.createClusters_ = function(iFirst) {
		...
		if (this.ready_) {
			...
			if (iLast < this.markers_.length)
				...
				for (
					delete this.timerRefStatic, google.maps.event.trigger(this, 'clusteringend', this), i = 0;
